...
class NuScenesMap:
    ...
    def _load_layers(self) -> None:
        ...
        self.road_segment = self._load_layer('road_segment')  # don't have direction
        self.road_block = self._load_layer('road_block')  # have direction
        self.lane = self._load_layer('lane')  # have direction
        # --------------------------------------------------
...
class NuScenesMapExplorer:
    ...
    # update, 210517
    def polygon_points(self, polygons):
